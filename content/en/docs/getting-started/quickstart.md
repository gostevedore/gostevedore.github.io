---
tags: ["getting-started", "installation", "configuration", "build", "promote", "images-tree"]
title: "Quickstart"
...
Alternatively, you can visit the [installation guide]({{< ref "/docs/getting-started/install">}}) for other methods.
